 ...
 * @author Axel Moreno
 */
public class Dialogpane extends javax.swing.JDialog 
{
     ...
     */
    public Dialogpane(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(420, 458));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialogpane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialogpane dialog = new Dialogpane(new javax.swing.JFrame(), true);
